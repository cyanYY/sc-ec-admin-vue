...
export function uploadOrder(params) {
  const url = '/wayBill/orderUpload?fileName=' + params.fileName + '&merchantId=' + params.merchantId
  return axios.post(url, params).then(res => res.data)
}
...
export function uploadOffOrder(params) {
  const url = '/wayBill/offOrderUpload?fileName=' + params.fileName + '&merchantId=' + params.merchantId
  return axios.post(url, params).then(res => res.data)
}

// 导入超区订单
export function uploadExrOrder(params) {
  const url = '/wayBill/exrOrderUpload?fileName=' + params.fileName + '&merchantId=' + params.merchantId
  return axios.post(url, params).then(res => res.data)
}
