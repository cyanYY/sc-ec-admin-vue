  ...
  <div class="app-container waybill-cont">
    <div class="queryForm">
      <el-form size="small" :inline="true" :model="queryForm" class="demo-form-inline">
        ...
        <el-form-item label="">
          <el-input v-model="queryForm.processResult" placeholder="处理结果"></el-input>
        </el-form-item>
        <el-form-item label="">
...
import { listPage, uploadWaybill, uploadWaybillException, handle, hang, trace } from '@/api/waybill-controller.js'
...
export default {
  ...
  methods: {
    ...
    waybillExceptionUploadHandle() {
      ...
      uploadWaybillException(param).then(res => {
    ...
    hangExceptionCommit() {
      var param = {
        ...
        hangReason: this.hangForm.hangReasonOther ? this.hangForm.hangReason + '|' + this.hangForm.hangReasonOther : this.hangForm.hangReason
      }
      hang(param).then(res => {
